...
//     if (i == 0) {
//       // if(red == 0) {
//         LEDPushRed(level, row, column, red, whichbyte, wholebyte);  //handle off state
//       // } else {
//       //   LEDWrapper(level, row, column, red, 0, 0, whichbyte, wholebyte);
//       // }
//     } else if (i == 1) {
//       // if(green == 0) {
//         LEDPushGreen(level, row, column, green, whichbyte, wholebyte);   //handle off state
//       // } else {
...
//     } else if (i == 2) {
//       // if(blue == 0) {
//         LEDPushBlue(level, row, column, blue, whichbyte, wholebyte);   //handle off state
//       // } else {
...
//         Serial.println("can get firestore doc");
//       } else {
